        ...
        usersList += `
            <li class="d-flex px-3 py-2 shadow-sm mb-2 rounded justify-content-between item__user"> 
                ...
                <div class="d-flex"> 
                    ...
                    <button class="btn btn-danger btn__delete__user pl-2" data-id="${user}" data-user="${user}" data-algo="${user}">Eliminar ${iconDelete}</button>
                    <a href="update-user.html?id=${user}" class="btn btn-warning">Actualizar usuario</a>
