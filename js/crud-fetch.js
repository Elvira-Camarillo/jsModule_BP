...
const deleteUser = (idUser) => {
    fetch(`https://koders1gpython-default-rtdb.firebaseio.com/elvira/users/${idUser}.json`, {
        method: 'DELETE'
    })
    .then(response => {
...
const readUsers = () => {
    ...
    fetch(`https://koders1gpython-default-rtdb.firebaseio.com/elvira/users/.json`, options )
    .then(response => {
        return response.json()
    })
    .then((users) => {  
...
const createUserFetch = (data) => {
    // create
    fetch(`https://koders1gpython-default-rtdb.firebaseio.com/elvira/users/.json`, {
        method: 'POST',
        headers: {
